...
CREATE DATABASE  IF NOT EXISTS `hanxin_moss` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `hanxin_moss`;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`iam`@`127.0.0.1`*/ /*!50003 TRIGGER `hanxin_moss`.`policy_BEFORE_DELETE` BEFORE DELETE ON `policy` FOR EACH ROW
BEGIN
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER="iam"@"127.0.0.1"*/ /*!50003 TRIGGER `hanxin_moss`.`user_BEFORE_DELETE` BEFORE DELETE ON `user` FOR EACH ROW
BEGIN
